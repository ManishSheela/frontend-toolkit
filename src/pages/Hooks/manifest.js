...
export const hookItems = [
  {
    slug: "use-previous",
    title: "usePrevious",
    description: "Custom hook to store the previous value of a state variable.",
  ...
  },
  {
    ...
    description: "Custom hook to manage local storage with a React state.",
    Component: lazy(() => import("./UseLocalStorageHook")),
  },
  {
    slug: "use-fetch",
    title: "useFetch",
    description: "Custom hook to fetch data from a REST API endpoint.",
    Component: lazy(() => import("./UseFetchHook")),
  },
  {
