const Home = () => {
	return (
		<div className="col-span-1 md:col-span-2">
			<div className="w-full max-w-3xl bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:shadow-black/40 border border-gray-200 dark:border-gray-800 p-6">
				...
				<div className="grid gap-4 md:grid-cols-2">
					<div className="bg-slate-50 dark:bg-gray-800 rounded-md p-4 border border-slate-100 dark:border-gray-700">
				...
				<div className="mt-6 flex flex-col md:flex-row items-center gap-4 bg-blue-50 dark:bg-blue-950/40 p-4 rounded-lg border border-blue-100 dark:border-blue-900">
					...
					<a
						...
						className="flex items-center gap-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-4 py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap shadow-sm"
					>
						⭐ Star on GitHub
					</a>
				</div>
