export const SidebarMenu = [
	{
		...
		items: [
			...
			},
			{
				...
				navigate: "mouse-hold-counter-app",
				description:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				description:
					"Turn a nested object into a flat object with dotted keys.",
			},
			{
				title: "Deep Clone",
				navigate: "deep-clone",
